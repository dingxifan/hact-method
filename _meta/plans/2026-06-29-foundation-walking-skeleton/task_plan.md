...
- 下一步：阶段 6 — skeleton/04(catalog 加 draft-foundation+source=foundation)+06(G2 用于 v0)+07(status.yml v0 迭代+type/source 枚举) + templates/status.yml + BRIEF(决策#25) + STATUS 里程碑 + 全仓 grep 验零悬挂。
