...
3. Codex 是 repository execution environment；ChatGPT 可以承担 reasoning、design、document authoring 与 acceptance。项目入口在 `templates/AGENTS.md`，canonical Task Contract 在 `tasks/`。修改职责时同步 Protocol、模板与检查器，不维护旧入口兼容层。
